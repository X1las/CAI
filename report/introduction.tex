...
This research is scoped to the Linux operating system and its filesystem operations. Linux provides a well-documented, standardised environment widely used in servers and embedded systems where autonomous agents are most likely to operate, and its filesystem acts as a natural substrate through which processes interact, keep data, and observe system states. All commands and system calls discussed relate specifically to this environment.

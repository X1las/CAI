...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/filebar.png}
    \caption{Traditional bar representation of memory usage}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/statemap.png}
    \caption{Grid-based state map representation of filesystem blocks, colorcoded by the state of the memory blocks}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../images/statemap-ai1.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../images/statemap-ai2.png}
    \end{minipage}
    \caption{Statemaps of agent 1 and agent 2 respectively, showing the state of the system as perceived by each agent.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/statemap-ai-all.png}
    \caption{Statemap showing the actual state of the system.}
\end{figure}
